                ...
                @endif
                    ...
                    <div class="form-group">
                        ...
                        <label class="radio-inline">
                            <input name="txtPayment" value="1" {{$bill_import->payment == 1 ? 'checked': ''}} type="radio">Trực tiếp
                        </label>
                        <label class="radio-inline">
                            <input name="txtPayment" value="0" {{$bill_import->payment == 0 ? 'checked': ''}}type="radio">Chuyển khoản
                        </label>
                    </div>
